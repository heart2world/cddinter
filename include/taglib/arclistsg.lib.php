...
function lib_arclistsg(&$ctag,&$refObj)
{
    ...
    //属性处理
    $attlist="typeid|0,row|10,col|1,flag|,titlelen|30,sort|default,keyword|,innertext|,arcid|0,idlist|,channelid|0,limit|,orderway|desc,subday|0,keyword1|";
    ...
    if($idlist=='')
    {
        ...
        if(!empty($keyword)) $orwheres[] = " AND arc.platform  ='$keyword'";
        if(!empty($keyword1)) $orwheres[] = " AND arc.industry  ='$keyword1'";
	...
	else if($orderby=='sort') $ordersql = "  ORDER BY arc.sort $orderway";
