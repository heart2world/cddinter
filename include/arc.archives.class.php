...
class Archives
{
    ...
    function GetPreNext2($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            $query = "Select arc.*,t.typedir,t.typename,t.namerule,t.namerule2,t.ispart,t.moresite,t.siteurl,t.sitepath
                        from `#@__addoninfos` arc left join #@__arctype t on arc.typeid=t.id  ";
            ...
            if(is_array($preRow))
            {
                ...
                if ( defined('DEDEMOB') )
                {
                    $mlink = 'view.php?aid='.$preRow['aid'];
                } else {
                    $mlink = GetFileUrl($preRow['aid'],$preRow['typeid'],$preRow['senddate'],$preRow['title'],$preRow['ismake'],$preRow['arcrank'],
                $preRow['namerule'],$preRow['typedir'],$preRow['money'],$preRow['filename'],$preRow['moresite'],$preRow['siteurl'],$preRow['sitepath']);
                }
                
                $this->PreNext['pre'] = "<a href='$mlink' class='ai-caselist-btnPrev'></a> ";
                $this->PreNext['preimg'] = "<a href='$mlink'><img src=\"{$preRow['litpic']}\" alt=\"{$preRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['pre'] = "<a href='javascript:;' class='ai-caselist-btnPrev'></a>";
                $this->PreNext['preimg'] ="<img src=\"/templets/default/images/nophoto.jpg\" alt=\"对不起，没有上一图集了！\"/>";
            }
            if(is_array($nextRow))
            {
                if ( defined('DEDEMOB') )
                {
                    ...
                    $mlink = GetFileUrl($nextRow['aid'],$nextRow['typeid'],$nextRow['senddate'],$nextRow['title'],$nextRow['ismake'],$nextRow['arcrank'],
                    $nextRow['namerule'],$nextRow['typedir'],$nextRow['money'],$nextRow['filename'],$nextRow['moresite'],$nextRow['siteurl'],$nextRow['sitepath']);
                }
    
                $this->PreNext['next'] = "<a href='$mlink' class='ai-caselist-btnNext'></a> ";
                $this->PreNext['nextimg'] = "<a href='$mlink'><img src=\"{$nextRow['litpic']}\" alt=\"{$nextRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['next'] = "<a href='javascript:;' class='ai-caselist-btnNext'></a> ";
                $this->PreNext['nextimg'] ="<a href='javascript:void(0)' alt=\"\"><img src=\"/templets/default/images/nophoto.jpg\" alt=\"对不起，没有下一图集了！\"/></a>";
            }
        }
        if($gtype=='pre')
