...
class DataListCP
{
     ...
     * @return    string
     */
    function __construct($catid=0,$tplfile='')
    {
    ...
    {
        global $lang_pre_page,$lang_next_page,$lang_index_page,$lang_end_page,$lang_record_number,$lang_page,$lang_total,$cfg_rewrite;
        ...
        $geturl = "catid=".$this->TypeID."&totalresult=".$this->totalResult."&";
        $purl .= '?'.$geturl;
		
        //获得上一页和下一页的链接
        if($this->pageNO != 1)
        {
            $prepage .= "<a href='".$purl."pageno=$prepagenum'>$lang_pre_page</a></span> \n";
        ...
        {
            $endpage=" <span>$lang_end_page</span> \n";
        }
        ...
        {
            $listdd .= $j==$this->pageNO ? "<a class='cur'>$j</a>\n" : "<a href='".$purl."pageno=$j'>".$j."</a>\n";
        }
        ...
        {	
            ...
            $plist = str_replace('.php?catid=', '-', $plist);
